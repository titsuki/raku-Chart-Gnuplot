use v6;
unit class Chart::Gnuplot:ver<0.0.23>;
...
=head1 How to use Chart::Gnuplot on jupyter?
...
The example ipynb file is here: L</notebooks/synopsis.ipynb|/notebooks/synopsis.ipynb>.
